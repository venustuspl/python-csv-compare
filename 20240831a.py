...
try:
    ...
    # Filter file2 to only include rows where column 2 is in car_brands
    ...
    duplicates = file1[file1.duplicated()]
    duplicates.to_csv(f"rvDuplicates_{current_datetime}.csv", index=False, header=False, sep=';')
